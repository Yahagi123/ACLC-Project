...
<body>
    ...
    <div class="choices">
            ...
            <a class="icons-size1 row2 icons-working" href="activitylogs.php"><div class="center-this"><img src="src/svg/button-log.svg" alt=""></div><p>Access Logs</p></a>
