...
void sendDigitalSerialNumber() {
  if (WiFi.status() == WL_CONNECTED) { // Check Wi-Fi connection
    HTTPClient http;
    const String url = "http://192.168.100.21/cloudfingerprintproject/insert_serial.php"; // Replace with your PHP API URL
...
void insertToSuspiciousLogsLogs(String typeee) {
  if (WiFi.status() == WL_CONNECTED) { // Check Wi-Fi connection
    HTTPClient http;
    http.begin("http://192.168.100.21/cloudfingerprintproject/SUSPICIOUSinsert_accessLogs.php"); // Replace with your PHP API URL
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");
...
void insertToLogs(String id) {
  if (WiFi.status() == WL_CONNECTED) { // Check Wi-Fi connection
    HTTPClient http;
    http.begin("http://192.168.100.21/cloudfingerprintproject/insert_accessLogs.php"); // Replace with your PHP API URL
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");
...
void deleteUserToDatabase() {
  if (WiFi.status() == WL_CONNECTED) { // Check Wi-Fi connection
    HTTPClient http;
    http.begin("http://192.168.100.21/cloudfingerprintproject/deleteOneUser.php"); // Replace with your PHP API URL
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");
...
void sendToFrontend(String message) {
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://192.168.100.21/cloudfingerprintproject/send_log.php"); // Replace with your logging endpoint
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");
...
int fetchFingerprintID() {
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://192.168.100.21/cloudfingerprintproject/get_fingerprint_id.php"); // Replace with your server endpoint
...
void dashboardSendThisTo(String sendThistoPage,String infodata) {
  if (WiFi.status() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("http://192.168.100.21/cloudfingerprintproject/loggedDashboardInformation.php"); // Replace with your logging endpoint
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");
    Serial.println("----------------------------");
