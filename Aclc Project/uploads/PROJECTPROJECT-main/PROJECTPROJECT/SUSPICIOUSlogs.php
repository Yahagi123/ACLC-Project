<?php 
include "SUSPICIOUSdisplayLogs.php";
session_start();
?>
...
<body>
        ...
        <div class="table-container">
            ...
            <table class="php-table">
                ...
                while($row = $result->fetch_assoc()){ ?>
                        ...
                        <tr id="rows-table" <?php if ($count % 2 == 0) echo 'class="even-color"'; ?>>
    ...
    <div class="choices">
            ...
            <a class="icons-size1 row2 icons-working" href="activitylogs.php"><div class="center-this"><img src="src/svg/button-log.svg" alt=""></div><p>All Logs</p></a>
            <a class="icons-size1 row2 icons-working" href="SUSPICIOUSlogs.php"><div class="center-this"><img src="src/svg/button-security.svg" alt=""></div><p>Suspicious Logs</p></a>
        </div>
