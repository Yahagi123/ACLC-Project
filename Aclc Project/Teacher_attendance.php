...
<div class="navbar">
    ...
    <div class="attendance-section" id="teacher-attendance">
            ...
            <div class="navigation">
                <ul>
                    <li><a href="SignUp.php"><img width="22" height="22" src="https://img.icons8.com/windows/32/plus-math.png" alt="plus-math"/>Create User</a></li>
            ...
            <table id="teacher-table">
                ...
                <tbody id="teacher-table-body">
                    <!-- Dynamic teacher data will be inserted here -->
                </tbody>
            </table>
        </div>
    </div>
