    ...
    <div class="navbar">
        ...
        <div class="nav-links">
            <ul>
                ...
                <li>
                    <form method="GET" action="collage.php">
                        ...
                        <select name="courses" id="course" class="form-control me-2">
                            ...
                            <option value="STEM" <?php echo isset($_GET['course']) && $_GET['course'] == 'STEM' ? 'selected' : ''; ?>>STEM</option>
                            <option value="ABM" <?php echo isset($_GET['course']) && $_GET['course'] == 'ABM' ? 'selected' : ''; ?>>ABM</option>
                            <option value="HUMSS" <?php echo isset($_GET['course']) && $_GET['course'] == 'HUMSS' ? 'selected' : ''; ?>>HUMSS</option>
                        </select>
                    </form>
                </li>
            </ul>
...
try {
    ...
    $sql = "SELECT `Image`, `Id_number`, `student name`, `Course`, `Year` FROM `student_create` WHERE `Year` = 'College'";
    if (!empty($search)) {
...
<div id="myModal" class="modal" style="display:none;">
    <div class="modal-content">
        ...
        <div style="margin-top: 15px;">
            <button><a href="update.php?id=" id="update-btn">Update</a></button>
        </div>
    </div>
</div>
